...
public class Barrier implements Serializable {
    ...
    private String welcomeSpeech;//出场欢迎词

    private String enterSpeech;//入场欢迎词

    private String staticSpeech;//静态欢迎词默认必填

    private String marketId;//市场ID

    private String watchhouseMacAddr;

    public String getWatchhouseMacAddr() {
        return watchhouseMacAddr;
    }

    public void setWatchhouseMacAddr(String watchhouseMacAddr) {
        this.watchhouseMacAddr = watchhouseMacAddr;
    }
    ...
    public String getEnterSpeech() {
        return enterSpeech;
    }

    public void setEnterSpeech(String enterSpeech) {
        this.enterSpeech = enterSpeech == null ? null : enterSpeech.trim();
    }
