...
// subYear==0,说明是同一年
     ...
     * @return
     */
    public static List<Map> getSplitTime(Date dateStart, Date dateEnd) {
        List<Map> listDays = new ArrayList<Map>();
        long days = getDateDiff(dateStart, dateEnd);
    ...
    /**
     * 根据Date获取"yyyy-MM-dd HH:mm:ss"字符串
     */
    public static String getSecondStr(Date date) {
        synchronized (formatTimestamp) {
            return getStr(date, formatTimestamp);
        }
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        /*try {
            Date date1 = LONG_DATE_FORMAT.parse("2018-10-06 17:12:45");
            Date date2 = LONG_DATE_FORMAT.parse("2018-10-07 13:27:12");
        ...
        System.out.println(getLongDateStr(date));
        System.out.println(getLongDateStr(endD));
    }
}
