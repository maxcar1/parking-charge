...
public class RedisUtil {
    ...
    private void initJedisPool() {
        ...
        int maxActive = Integer.parseInt(properties.getString("redisMaxActive"));
        int maxIdle = Integer.parseInt(properties.getString("redisMaxIdle"));
...
//        String werwe = RedisUtil.getInstance().strings().set("k2", JSON.toJSONString(map));
//        RedisUtil.getInstance().keys().expire("k2", 60); 
//        System.out.println(werwe);
//        String s = RedisUtil.getInstance().strings().get("werwe");
//        System.out.println(s);

//        System.out.println(RedisUtil.getInstance().keys().keys("*"));
//        RedisUtil.getInstance().hash.hset("aaaa", "01", "1");
//       System.out.println( RedisUtil.getInstance().hash.hget("taobao_007", "01"));
        RedisUtil.getInstance().keys().incr("key");
        System.out.println(RedisUtil.getInstance().getJedis().get("key"));
