...
public class AreaVo implements Serializable {
    ...
    private Integer detailCount;//详细数量

    private List<AreaShop> areaShops;
    ...
    public List<AreaShop> getAreaShops() {
        return areaShops;
    }

    public void setAreaShops(List<AreaShop> areaShops) {
        this.areaShops = areaShops;
    }
