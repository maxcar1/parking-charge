...
import com.maxcar.controller.PaiBoWxController;
...
public class ICarController {
    ...
    public Object handleWeiXin(HttpServletRequest request){
        ...
        try {
            ...
            JSONObject json = weiXinService.handlePublicMsg(res,WeiXinUtils.WeiXinPublicNum.ICAR);
